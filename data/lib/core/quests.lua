if not Quests then
	Quests = {
		...
		[44] = {
			name = "Verified",
			startStorageId = Storage.Verified,
			startStorageValue = 1,
			missions = {
				[1] = {
					name = "Verified",
					storageId = Storage.Verified,
					missionId = 10420,
					startValue = 1,
					endValue = 1,
					description = "Checando se voce ja logou no servidor."
				},
				[2] = {
					name = "Double Verified",
					storageId = Storage.Verified,
					missionId = 10421,
					startValue = 1,
					endValue = 2,
					description = "Checando se voce ja fez a verificacao atraves do npc ou item."
				}
			}
		},
		...
		[45] = {
			name = "DropRate",
			startStorageId = Storage.DropRate,
			startStorageValue = 0,
			missions = {
				[1] = {
					name = "Drop Rate Inicial",
					storageId = Storage.DropRate,
					missionId = 10422,
					startValue = 0,
					endValue = 0,
					description = "Drop Rate inicial do server"
				},
				[2] = {
					name = "Drop Rate level 2",
					storageId = Storage.DropRate,
					missionId = 10423,
					startValue = 0,
					endValue = 1,
					description = "+10% no Drop Rate"
				},
				[3] = {
					name = "Drop Rate level 3",
					storageId = Storage.DropRate,
					missionId = 10424,
					startValue = 0,
					endValue = 2,
					description = "+20% no Drop Rate"
				},
				[4] = {
					name = "Drop Rate level 4",
					storageId = Storage.DropRate,
					missionId = 10425,
					startValue = 0,
					endValue = 3,
					description = "+30% no Drop Rate"
				},
				[5] = {
					name = "Drop Rate level 5",
					storageId = Storage.DropRate,
					missionId = 10426,
					startValue = 0,
					endValue = 4,
					description = "+40% no Drop Rate"
				},
				[6] = {
					name = "Drop Rate level 6",
					storageId = Storage.DropRate,
					missionId = 10427,
					startValue = 0,
					endValue = 5,
					description = "+50% no Drop Rate"
				},
			}
		},
