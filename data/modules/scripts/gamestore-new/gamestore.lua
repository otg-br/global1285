...
-- Boost
 {   
   ...
   offers = { 
		...
		{
				icons = { "otserv_SkillBoost.png" },
				name = "Skill Boost 1 Day",
				price = 2,
				count = 24, 
				
				id = 65011,
				type = GameStore.OfferTypes.OFFER_TYPE_SKILLBOOST,
			
				description = "Fast Skill gain.",
			},
      },
   rookgaard = true,
   state = GameStore.States.STATE_NONE,
