...
function playerLogin.onLogin(player)
	...
	if skilltime > 0 then
	local horas = math.floor(skilltime/3600)
    local minutos = math.floor((skilltime - (horas * 3600))/60)
		player:sendTextMessage(MESSAGE_INFO_DESCR, string.format("Voce tem ".. horas .." horas e ".. minutos .." minutos restantes de skill boost"))
	end
